...
function ProviderRow({
  ...
  return (
    <Box>
      ...
      <Text color={(keySet ? 'success' : 'warning') as keyof Theme}>
        [{keyLabel}]
      </Text>
    </Box>
  )
  ...
  if (props.mode === 'list') {
    ...
    return (
      <Box flexDirection="column">
        ...
        <Box marginTop={1}>
          <Text dimColor>
            Use /providers use &lt;id&gt; to switch providers (restart required)
          </Text>
        </Box>
      </Box>
    )
  ...
  if (props.mode === 'show') {
    ...
    if (!provider) {
      return (
        <Box>
          <Text dimColor>
            No active OpenAI-compat provider. Use /providers use &lt;id&gt; to activate one.
          </Text>
        </Box>
      )
    }
  ...
  if (props.mode === 'added') {
    ...
    return (
      <Box flexDirection="column">
        ...
        <Text dimColor>
          Use /providers use {provider.id} to activate it (restart required).
        </Text>
      </Box>
    )
  }
